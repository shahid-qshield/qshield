...
class ContactCustom(models.Model):
    ...
    employee_ids = fields.One2many('hr.employee', 'partner_id', string="Related Employee", auto_join=True,readonly=False)
    is_qshield_sponsor = fields.Boolean(string='Is Qshield Sponsor', compute='_compute_is_qshield_sponsor', store=True ,readonly=False)
